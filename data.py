...
def convert_example(example, tokenizer, query_max_seq_length=32, title_max_seq_length=128):
    """
    ...
    encoded_inputs = tokenizer(text=example["query"], max_seq_len=query_max_seq_length)
    query_input_ids = encoded_inputs["input_ids"]
    query_token_type_ids = encoded_inputs["token_type_ids"]

    encoded_inputs = tokenizer(text=example["pos_title"], text_pair=example["pos_para"], max_seq_len=title_max_seq_length)
    pos_title_input_ids = encoded_inputs["input_ids"]
    pos_title__token_type_ids = encoded_inputs["token_type_ids"]

    encoded_inputs = tokenizer(text=example["neg_title"], text_pair=example["neg_para"], max_seq_len=title_max_seq_length)
    neg_title_input_ids = encoded_inputs["input_ids"]
    neg_title__token_type_ids = encoded_inputs["token_type_ids"]

    result = [query_input_ids, query_token_type_ids, pos_title_input_ids, pos_title__token_type_ids, neg_title_input_ids, neg_title__token_type_ids]
