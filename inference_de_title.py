...
from data import read_text, convert_inference_example, create_dataloader, read_dev_text, read_passage_text, convert_inference_example_para
...
if __name__ == "__main__":
    ...
    trans_func = partial(
        convert_inference_example_para,
        tokenizer=tokenizer,
    ...
    valid_ds = load_dataset(read_passage_text, data_path=args.text_file, lazy=False)
